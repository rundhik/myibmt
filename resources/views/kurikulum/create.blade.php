...
@section('judul', 'Tambah Kurikulum')
                ...
                <div class="col-xl-12">
                    ...
                    <div class="m-portlet m-portlet--mobile">
                        ...
                        <div class="m-portlet__body">
                            <!--begin: Body -->
                        <form class="m-form m-form--fit m-form--label-align-right" action="{{route('kurikulum.store')}}" method="POST">
                                @csrf
                                    <div class="m-portlet__body">
                                        <div class="form-group m-form__group row">
                                            <label class="col-form-label col-lg-3 col-sm-12">Nama Kurikulum</label>
                                            <div class="col-lg-4 col-md-9 col-sm-12">
                                                <input type="text" name="nm_kurikulum" class="form-control m-input">
                                            </div>
                                        </div>
                                        <div class="form-group m-form__group row">
